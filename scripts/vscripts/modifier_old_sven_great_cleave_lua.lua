modifier_old_sven_great_cleave_lua = class({})

--------------------------------------------------------------------------------

function modifier_old_sven_great_cleave_lua:IsHidden()
	return true
end

--------------------------------------------------------------------------------

function modifier_old_sven_great_cleave_lua:OnCreated( kv )
...
function modifier_old_sven_great_cleave_lua:OnRefresh( kv )
	self.great_cleave_damage = self:GetAbility():GetSpecialValueFor( "great_cleave_damage" )
	self.great_cleave_radius = self:GetAbility():GetSpecialValueFor( "great_cleave_radius" )
end
...
function modifier_old_sven_great_cleave_lua:DeclareFunctions()
	local funcs = {
...
function modifier_old_sven_great_cleave_lua:OnAttackLanded( params )
	if IsServer() then
