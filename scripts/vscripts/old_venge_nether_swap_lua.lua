old_venge_nether_swap_lua = class({})

--------------------------------------------------------------------------------

function old_venge_nether_swap_lua:GetAOERadius()
	return self:GetSpecialValueFor( "radius" )
end

--------------------------------------------------------------------------------

function old_venge_nether_swap_lua:CastFilterResultTarget( hTarget )
...
function old_venge_nether_swap_lua:GetCustomCastErrorTarget( hTarget )
	if self:GetCaster() == hTarget then
...
function old_venge_nether_swap_lua:GetCooldown( nLevel )
...
function old_venge_nether_swap_lua:OnSpellStart()
