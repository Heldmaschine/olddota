old_sven_gods_strength_lua = class({})
LinkLuaModifier( "modifier_old_sven_gods_strength_lua", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------

function old_sven_gods_strength_lua:OnSpellStart()
	local gods_strength_duration = self:GetSpecialValueFor( "gods_strength_duration" )

	self:GetCaster():AddNewModifier( self:GetCaster(), self, "modifier_old_sven_gods_strength_lua", { duration = gods_strength_duration }  )
