old_furion_wrath_of_nature_lua = class({})
LinkLuaModifier( "modifier_old_furion_wrath_of_nature_thinker_lua", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------

function old_furion_wrath_of_nature_lua:OnAbilityPhaseStart()
...
function old_furion_wrath_of_nature_lua:OnSpellStart()
	...
	CreateModifierThinker( self:GetCaster(), self, "modifier_old_furion_wrath_of_nature_thinker_lua", kv, self.vTargetPos, self:GetCaster():GetTeamNumber(), false )
end
