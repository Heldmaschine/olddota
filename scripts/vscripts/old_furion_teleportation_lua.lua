old_furion_teleportation_lua = class({})
LinkLuaModifier( "modifier_old_furion_teleportation_lua", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------

function old_furion_teleportation_lua:OnAbilityPhaseStart()
	...
	self:GetCaster():AddNewModifier( self:GetCaster(), self, "modifier_old_furion_teleportation_lua", kv )
...
function old_furion_teleportation_lua:OnAbilityPhaseInterrupted()
	...
	self:GetCaster():RemoveModifierByName( "modifier_old_furion_teleportation_lua" )
...
function old_furion_teleportation_lua:OnSpellStart()
