modifier_old_furion_wrath_of_nature_thinker_lua = class({})

--------------------------------------------------------------------------------

function modifier_old_furion_wrath_of_nature_thinker_lua:IsHidden()
	return true
end

--------------------------------------------------------------------------------

function modifier_old_furion_wrath_of_nature_thinker_lua:OnCreated( kv )
...
function modifier_old_furion_wrath_of_nature_thinker_lua:OnDestroy()
	if IsServer() then
...
function modifier_old_furion_wrath_of_nature_thinker_lua:OnIntervalThink()
	if IsServer() then
...
function modifier_old_furion_wrath_of_nature_thinker_lua:GetNextTarget()
...
function modifier_old_furion_wrath_of_nature_thinker_lua:HitTarget( hTarget )
	if hTarget == nil then
		return
	end
...
function modifier_old_furion_wrath_of_nature_thinker_lua:CreateBounceFX( hTarget )
	--FX
