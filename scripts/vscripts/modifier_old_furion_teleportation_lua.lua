modifier_old_furion_teleportation_lua = class({})

--------------------------------------------------------------------------------

function modifier_old_furion_teleportation_lua:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_old_furion_teleportation_lua:OnCreated( kv )
	if IsServer() then
...
function modifier_old_furion_teleportation_lua:OnDestroy()
	if IsServer() then
...
function modifier_old_furion_teleportation_lua:OnIntervalThink()
	if IsServer() then
		StopSoundOn( "Hero_Furion.Teleport_Grow", self:GetCaster() )
		StopSoundOn( "Hero_Furion.Teleport_Grow", self:GetCaster() )
