old_venge_magic_missile_lua = class({})
LinkLuaModifier( "modifier_old_venge_magic_missile_lua", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------

function old_venge_magic_missile_lua:OnSpellStart()
	local info = {
...
function old_venge_magic_missile_lua:OnProjectileHit( hTarget, vLocation )
	if hTarget ~= nil and ( not hTarget:IsInvulnerable() ) and ( not hTarget:TriggerSpellAbsorb( self ) ) and ( not hTarget:IsMagicImmune() ) then
		...
		ApplyDamage( damage )
		hTarget:AddNewModifier( self:GetCaster(), self, "modifier_old_venge_magic_missile_lua", { duration = magic_missile_stun } )
	end
