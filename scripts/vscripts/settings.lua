...
UNIVERSAL_SHOP_MODE = true--until play test             -- Should the main shop contain Secret Shop items as well as regular items
ALLOW_SAME_HERO_SELECTION = false        -- Should we let people select the same hero as each other

HERO_SELECTION_TIME = 60.0              -- How long should we let people select their hero?
PRE_GAME_TIME = 30.0 --change to in 60 play test                   -- How long after people select their heroes should the horn blow and the game start?
...
USE_STANDARD_HERO_GOLD_BOUNTY = true--change in playtest    -- Should we give gold for hero kills the same as in Dota, or allow those values to be changed?
...
MAXIMUM_ATTACK_SPEED = 500              -- What should we use for the maximum attack speed?
